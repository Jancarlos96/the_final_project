...
Personaje::Personaje() : GameObject(
        GameObject::Personaje, QPixmap(":/Sprite/personajes/mejorado1.png"))
{
    dir = Stop;
    next_dir = Stop;
    anim_index = 0;//era =2
    anim[Right].push_back(QPixmap(":/Sprite/personajes/mejorado1.png"));
    anim[Right].push_back(QPixmap(":/Sprite/personajes/mejorado2.png"));

    anim[Up].push_back(QPixmap(":/Sprite/personajes/izquierda1.png"));
    anim[Up].push_back(QPixmap(":/Sprite/personajes/izquierda2.png"));

    anim[Left].push_back(QPixmap(":/Sprite/personajes/izquierda1.png"));
    anim[Left].push_back(QPixmap(":/Sprite/personajes/izquierda2.png"));


    anim[Down].push_back(QPixmap(":/Sprite/personajes/mejorado1.png"));
    anim[Down].push_back(QPixmap(":/Sprite/personajes/mejorado2.png"));
...
void Personaje::eat_ball(int __y, int __x)
{
...
bool Personaje::overlapable(int i, int j)
{
    if (i < 0 || j < 0) {
        return false;
    }
